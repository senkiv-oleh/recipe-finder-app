...
const RecipeDetails = ({ recipe }: { recipe: RecipeDetailsType }) => {
  return (
    <>
      <Link
        href='/recipes'
        className='group inline-flex items-center transparent justify-center h-12 rounded-full hover:bg-gray-800 transition text-black
        bg-white hover:text-white
          px-4 py-2 text-sm font-semibold
        border border-gray-800 border-2 hover:border-white mb-4 fixed ml-[-130px] z-10'
      >
        <svg
          className='w-6 h-6 
          text-black group-hover:text-white transition mr-2'
          aria-hidden='true'
